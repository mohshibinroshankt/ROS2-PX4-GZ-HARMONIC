...
#include "translation_node/srv/detail/test_v1__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = translation_node::srv::TestV1_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const translation_node::srv::TestV1_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<translation_node::srv::TestV1_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TestV1_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const translation_node::srv::TestV1_Request *>(
...
static size_t _TestV1_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TestV1_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TestV1_Request__callbacks = {
...
static rosidl_message_type_support_t _TestV1_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TestV1_Request__callbacks,
...
{
  return &translation_node::srv::typesupport_fastrtps_cpp::_TestV1_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = translation_node::srv::TestV1_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const translation_node::srv::TestV1_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<translation_node::srv::TestV1_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TestV1_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const translation_node::srv::TestV1_Response *>(
...
static size_t _TestV1_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TestV1_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TestV1_Response__callbacks = {
  "translation_node::srv",
  "TestV1_Response",
...
static rosidl_message_type_support_t _TestV1_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TestV1_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &translation_node::srv::typesupport_fastrtps_cpp::_TestV1_Response__handle;
}
...
static service_type_support_callbacks_t _TestV1__callbacks = {
  "translation_node::srv",
  "TestV1",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, translation_node, srv, TestV1_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, translation_node, srv, TestV1_Response)(),
...
static rosidl_service_type_support_t _TestV1__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TestV1__callbacks,
...
{
  return &translation_node::srv::typesupport_fastrtps_cpp::_TestV1__handle;
}
