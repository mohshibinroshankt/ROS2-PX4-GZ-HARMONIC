...
translation_node__srv__TestV0_Request__create()
{
  ...
  translation_node__srv__TestV0_Request * msg = (translation_node__srv__TestV0_Request *)allocator.allocate(sizeof(translation_node__srv__TestV0_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(translation_node__srv__TestV0_Request));
  bool success = translation_node__srv__TestV0_Request__init(msg);
  if (!success) {
...
translation_node__srv__TestV0_Request__destroy(translation_node__srv__TestV0_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    translation_node__srv__TestV0_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
translation_node__srv__TestV0_Request__Sequence__init(translation_node__srv__TestV0_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  translation_node__srv__TestV0_Request * data = NULL;

  if (size) {
    data = (translation_node__srv__TestV0_Request *)allocator.zero_allocate(size, sizeof(translation_node__srv__TestV0_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = translation_node__srv__TestV0_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        translation_node__srv__TestV0_Request__fini(&data[i - 1]);
      }
...
translation_node__srv__TestV0_Request__Sequence__fini(translation_node__srv__TestV0_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      translation_node__srv__TestV0_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  translation_node__srv__TestV0_Request__Sequence * array = (translation_node__srv__TestV0_Request__Sequence *)allocator.allocate(sizeof(translation_node__srv__TestV0_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = translation_node__srv__TestV0_Request__Sequence__init(array, size);
  if (!success) {
...
translation_node__srv__TestV0_Request__Sequence__destroy(translation_node__srv__TestV0_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    translation_node__srv__TestV0_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
translation_node__srv__TestV0_Request__Sequence__are_equal(const translation_node__srv__TestV0_Request__Sequence * lhs, const translation_node__srv__TestV0_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!translation_node__srv__TestV0_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  translation_node__srv__TestV0_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(translation_node__srv__TestV0_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    translation_node__srv__TestV0_Request * data =
      (translation_node__srv__TestV0_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!translation_node__srv__TestV0_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          translation_node__srv__TestV0_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!translation_node__srv__TestV0_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  translation_node__srv__TestV0_Response * msg = (translation_node__srv__TestV0_Response *)allocator.allocate(sizeof(translation_node__srv__TestV0_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(translation_node__srv__TestV0_Response));
  bool success = translation_node__srv__TestV0_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
translation_node__srv__TestV0_Response__destroy(translation_node__srv__TestV0_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    translation_node__srv__TestV0_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
translation_node__srv__TestV0_Response__Sequence__init(translation_node__srv__TestV0_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  translation_node__srv__TestV0_Response * data = NULL;

  if (size) {
    data = (translation_node__srv__TestV0_Response *)allocator.zero_allocate(size, sizeof(translation_node__srv__TestV0_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = translation_node__srv__TestV0_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        translation_node__srv__TestV0_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
translation_node__srv__TestV0_Response__Sequence__fini(translation_node__srv__TestV0_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      translation_node__srv__TestV0_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  translation_node__srv__TestV0_Response__Sequence * array = (translation_node__srv__TestV0_Response__Sequence *)allocator.allocate(sizeof(translation_node__srv__TestV0_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = translation_node__srv__TestV0_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
translation_node__srv__TestV0_Response__Sequence__destroy(translation_node__srv__TestV0_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    translation_node__srv__TestV0_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
translation_node__srv__TestV0_Response__Sequence__are_equal(const translation_node__srv__TestV0_Response__Sequence * lhs, const translation_node__srv__TestV0_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!translation_node__srv__TestV0_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  translation_node__srv__TestV0_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(translation_node__srv__TestV0_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    translation_node__srv__TestV0_Response * data =
      (translation_node__srv__TestV0_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!translation_node__srv__TestV0_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          translation_node__srv__TestV0_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!translation_node__srv__TestV0_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
