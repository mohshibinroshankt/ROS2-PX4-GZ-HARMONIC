...
static const _TestV2_Request_type_support_symbol_names_t _TestV2_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, translation_node, srv, TestV2_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, translation_node, srv, TestV2_Request)),
  }
};
...
{
  return &::translation_node::srv::rosidl_typesupport_cpp::TestV2_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, translation_node, srv, TestV2_Request)() {
  return get_message_type_support_handle<translation_node::srv::TestV2_Request>();
}
...
static const _TestV2_Response_type_support_symbol_names_t _TestV2_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, translation_node, srv, TestV2_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, translation_node, srv, TestV2_Response)),
  }
};
...
{
  return &::translation_node::srv::rosidl_typesupport_cpp::TestV2_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, translation_node, srv, TestV2_Response)() {
  return get_message_type_support_handle<translation_node::srv::TestV2_Response>();
}
...
static const _TestV2_type_support_symbol_names_t _TestV2_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, translation_node, srv, TestV2)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, translation_node, srv, TestV2)),
  }
};
...
{
  return &::translation_node::srv::rosidl_typesupport_cpp::TestV2_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, translation_node, srv, TestV2)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<translation_node::srv::TestV2>();
}
