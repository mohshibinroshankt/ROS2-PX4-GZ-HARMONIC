...
static const _TestV1_Request_type_support_symbol_names_t _TestV1_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, translation_node, srv, TestV1_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, translation_node, srv, TestV1_Request)),
  }
};
...
{
  return &::translation_node::srv::rosidl_typesupport_cpp::TestV1_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, translation_node, srv, TestV1_Request)() {
  return get_message_type_support_handle<translation_node::srv::TestV1_Request>();
}
...
static const _TestV1_Response_type_support_symbol_names_t _TestV1_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, translation_node, srv, TestV1_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, translation_node, srv, TestV1_Response)),
  }
};
...
{
  return &::translation_node::srv::rosidl_typesupport_cpp::TestV1_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, translation_node, srv, TestV1_Response)() {
  return get_message_type_support_handle<translation_node::srv::TestV1_Response>();
}
...
static const _TestV1_type_support_symbol_names_t _TestV1_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, translation_node, srv, TestV1)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, translation_node, srv, TestV1)),
  }
};
...
{
  return &::translation_node::srv::rosidl_typesupport_cpp::TestV1_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, translation_node, srv, TestV1)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<translation_node::srv::TestV1>();
}
